...
export interface Mutation {
  ...
  RemoveAuthQuestion: RemoveAuthQuestionResponse;
  RemoveQuestion: RemoveQuestionResponse;
  UpdateQuestion: UpdateQuestionResponse;
  ValidPassword: ValidPasswordResponse;
...
export interface RemoveAuthQuestionMutationArgs {
  id: string;
}
...
export interface ValidPasswordMutationArgs {
  id: string;
  password: string;
}
...
export interface RemoveAuthQuestionResponse {
  ok: boolean;
  error: string | null;
}
...
export interface ValidPasswordResponse {
  ok: boolean | null;
  error: string | null;
}
